...
const companyEn:Record<string,string>={"أرامكو السعودية":"Saudi Aramco","الاتحاد للطيران":"Etihad Airways","قطر للطاقة":"QatarEnergy","السعودية لهندسة وصناعة الطيران":"Saudi Arabian Military Industries","طيران الخليج":"Gulf Air","مجموعة طيران الخليج":"Gulf Air Group","الخطوط السعودية":"Saudia","شركة مطار البحرين":"Bahrain Airport Company"};
const cityEn:Record<string,string>={"الظهران":"Dhahran","الرياض":"Riyadh","جدة":"Jeddah","الدوحة":"Doha","المنامة":"Manama","المحرق":"Muharraq","أبوظبي":"Abu Dhabi","أبوظبي والعين":"Abu Dhabi and Al Ain","مدن متعددة":"Multiple locations","مواقع متعددة":"Multiple locations"};
const typeEn:Record<string,string>={"دوام كامل":"Full-time","دوام جزئي":"Part-time","تدريب":"Internship","عقد":"Contract","مؤقت":"Temporary"};
