...
export const metadata = { title: "الشركات التي توظف في الخليج", description: "اكتشف الشركات وفرص العمل المنشورة لديها في دول الخليج.", alternates:{canonical:"/companies"} };
...
export default async function Companies() {
  ...
  const companies=[...grouped.values()].filter(c=>!c.name.includes("تجريب")).sort((a,b)=>b.count-a.count);
