...
export type HomeArticle = { slug:string; title:string; category:string; excerpt:string; imageUrl:string; readTime:string };
...
export function HomeClient({initialJobs,initialArticles}:{initialJobs:HomeJob[];initialArticles:HomeArticle[]}) {
  ...
  return <main dir="rtl" className="min-h-screen overflow-hidden bg-[#f5f8fa] text-[#10263a]">
    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 backdrop-blur-xl">
      <div className="container-shell flex h-[82px] items-center justify-between gap-6">
        ...
        <div className="hidden items-center gap-3 md:flex"><a href="/en" className="rounded-lg px-3 py-2 text-sm font-extrabold text-[#526779] hover:bg-slate-100">English</a><Button asChild className="h-11 rounded-xl bg-[#071a2e] px-5 font-extrabold text-white hover:bg-[#0e2c48]"><a href="/admin">أعلن عن وظيفة</a></Button></div>
    ...
    <footer className="bg-[#061523] py-10 text-white"><div className="container-shell flex flex-col items-start justify-between gap-7 md:flex-row md:items-center"><Brand inverse /><div className="max-w-lg"><p className="text-sm font-medium leading-7 text-slate-400">منصة عربية تجمع الباحثين عن فرص مهنية مميزة مع شركات موثوقة في جميع دول الخليج.</p><a className="mt-2 inline-block text-sm font-bold text-[#d1ad62] transition hover:text-white" href="mailto:contact@tawteenjobs.com" dir="ltr">contact@tawteenjobs.com</a></div><div className="flex flex-wrap gap-5 text-sm font-bold text-white/70"><a href="/privacy">الخصوصية</a><a href="/terms">الشروط</a><a href="/cookies">ملفات الارتباط</a><a href="/contact">تواصل معنا</a></div></div></footer>
  </main>;
}
